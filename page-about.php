  ...
  <main id="main" class="site-main">
    <div class="about">
      ...
      <p class="modText">
        ...
        フラメンコ、フラダンス、タップなど様々なダンスを<br class="sm-only">融合したダンスを、<br />
      ...
      <div class="about__contents">
        <div class="about__contentsBox">
          <figure class="about__contentsBox__img">
            <figcaption class="about__contentsBox__imgCap">
              <p class="about__contentsBox__imgCap--en">Styles</p>
        ...
        <div class="about__contentsBox">
          <div class="about__contentsBox__text">
            講師の<a href="/instructor">河野麻耶（こうのまや）</a>は、祖母・金光郁子のもとで1歳よりダンスを学びダンス一家の血を受け継ぎました。舞踊歴は40年以上。日本ジャズダンス芸術協会主催コンクールにて1991年ジュニアの部次点、1996年成人部門特別賞、2002年アダルト部門第1位、2007年にはコンクール最高位のグランプリを受賞。同ダンスコンクールの審査員も昨今は務めています。前身である金光郁子舞踊学園での商業講演や発表会、（一社）日本ジャズダンス芸術協会主催公演は30回以上出演、その他外部公演にも積極的に参加し豊富な経験があります。</div>
          <figure class="about__contentsBox__img">
            <figcaption class="about__contentsBox__imgCap">
              <p class="about__contentsBox__imgCap--en">Experienced</p>
        ...
        <div class="about__contentsBox">
          <figure class="about__contentsBox__img">
            <figcaption class="about__contentsBox__imgCap">
              <p class="about__contentsBox__imgCap--en">Curriculum</p>
        ...
        <div class="about__contentsBox">
          <div class="about__contentsBox__text">Leia Dance Studio では、10代から70代まで幅広い年齢層の方々が一緒に踊り、笑顔が絶えないスタジオです。生徒一人ひとりを大切にし、初心者でも安心して楽しめる環境を提供しています。ダンスを通じて心と体をリフレッシュしながら、新しい仲間との絆も深まるアットホームな空間で、楽しく踊りましょう！</div>
          <figure class="about__contentsBox__img">
            <figcaption class="about__contentsBox__imgCap">
              <p class="about__contentsBox__imgCap--en">Homey</p>
        ...
        <div class="about__contentsBox">
          <figure class="about__contentsBox__img">
            <figcaption class="about__contentsBox__imgCap">
              <p class="about__contentsBox__imgCap--en">Healthy</p>
